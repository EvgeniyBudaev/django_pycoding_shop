...
class Product(models.Model):
  ...
  price = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Цена')  # decimal_places - количество цифр после запятой
...
class Cart(models.Model):
  ...
  products = models.ManyToManyField(CartProduct, blank=True, related_name='related_cart')  # blank=True - данное поле не обязательно к заполнению. cart.related_products.all() получаем querySet со всеми продуктами, которые в данный момент находятся в данной корзине
